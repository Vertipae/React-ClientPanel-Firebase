              ...
              <form onSubmit={this.onSubmit}>
                <div className="form-group">
                  ...
                  <input
                    ...
                    minLength="2"
                    required
                    //   onChange={this.onChange} <- not setting the state like in AddClient
                    // Value comes from the props not from the state like in AddClient
